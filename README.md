...
```
git clone https://github.com/TheDoctor314/material-awesome.git ~/.config/awesome
```
...
```
git clone -b awesome-4.2 https://github.com/TheDoctor314/material-awesome.git ~/.config/awesome
```
